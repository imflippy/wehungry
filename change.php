        ...
        <div class="container">
            <div class="row">
                <div class="col-xs-12 col-sm-12">
                    <form action="proveraChange.php" method="POST">

                        <input type="hidden" name="id" id="id" value="<?= $korisnik_ch->id ?>"/>

                        <label>First Name</label>
                        <input type="text" name="tbFirst" id="tbFirst" class="form-control" value="<?php echo $korisnik_ch->ime; ?>"/>

                        <label>Last Name</label>
                        <input type="text" name="tbLast" id="tbLast" class="form-control" value="<?= $korisnik_ch->prezime ?>"/>
                        ...
                        <button class="bttn black" type="button" name="btnChange" id="btnChange">Change</button>
                    </form>
...
?>
    <script src="js/proveraChange.js" type="text/javascript"></script>
